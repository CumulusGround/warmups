...
var arrayToFilter = ["Mallard", "Hook Bill", "African", "Crested", "Pilgrim", "Toulouse", "Blue Swedish"]


var gooseFilter = function(arrayToFilter) {
    
    var geese = ["African", "Roman Tufted", "Toulouse", "Pilgrim", "Steinbacher"]
    
    geese.forEach(word => {
    
        indexToCut = arrayToFilter.indexOf(word)
        if (indexToCut !== -1)  {
            arrayToFilter.splice(indexToCut,1)
        }
    })
